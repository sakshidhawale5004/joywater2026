      ...
      <div className="max-w-7xl mx-auto px-8 py-16 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            ...
            <li><Link to="/about" className="hover:text-gold">About Joy Water</Link></li>
            <li><Link to="/contact" className="hover:text-gold">Contact</Link></li>
            <li><Link to="/warranty" className="hover:text-gold">Warranty</Link></li>
            <li><Link to="/care" className="hover:text-gold">Care & Maintenance</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-xs uppercase tracking-[0.2em] text-gold mb-4">Visit</h4>
          <p className="text-sm text-primary-foreground/80 leading-relaxed">
            Joy Water Display Centre<br />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5 text-gold" /> <span>Manoj Pandey<br /><a href="tel:+919325948289" className="hover:text-gold">+91 93259 48289</a></span></li>
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5 text-gold" /> <span>Swapnil Jain<br /><a href="tel:+917083845647" className="hover:text-gold">+91 70838 45647</a></span></li>
            <li className="flex items-start gap-2"><Mail className="h-4 w-4 mt-0.5 text-gold" /> <a href="mailto:hello@joywater.in" className="hover:text-gold">hello@joywater.in</a></li>
          </ul>
        </div>
      </div>
