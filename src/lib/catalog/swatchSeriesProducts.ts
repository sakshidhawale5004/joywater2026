...
export const swatchSeriesProducts: Product[] = [
  ...
  {
    id: "swatch-rose-gold-sw-rg-107",
    name: "Paper Holder With Flap",
    slug: "swatch-rose-gold-sw-rg-107",
    category: "swatch-rose-gold",
    finish: "PVD Rose Gold Finish",
    price: 3600,
    code: "SW-RG 107",
