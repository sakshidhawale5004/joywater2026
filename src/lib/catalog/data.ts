...
export const categories: Category[] = [
  ...
  // Resources / ideas
  {
    slug: "faucets-in-special-finishes",
    title: "Faucets in Special Finishes",
    group: "resources",
    description: "Explore faucets in special finishes.",
  },
  {
    slug: "sanitaryware-in-special-finishes",
    title: "Sanitaryware in Special Finishes",
    group: "resources",
    description: "Sanitaryware in bespoke finishes.",
  },
  {
    slug: "wash-basins-in-alternate-materials",
    title: "Wash Basins in Alternate Materials",
    group: "resources",
    description: "Wash basins in alternate materials.",
  },
  {
    slug: "stone-finish-wash-basin",
    title: "Stone Finish Wash Basin",
    group: "resources",
    description: "Natural stone wash basins.",
  },
  {
    slug: "creating-a-home-spa",
    title: "Creating a Home Spa",
    group: "resources",
    description: "Design ideas for a home spa.",
  },
  {
    slug: "shower-area-configurations",
    title: "Shower-Area Configurations",
    group: "resources",
    description: "Shower area layout ideas.",
  },
];
...
export const megaMenu = {
  ...
  Resources: {
    "Ideas & Trends": [
      ...
      "sanitaryware-in-special-finishes",
      "wash-basins-in-alternate-materials",
      "stone-finish-wash-basin",
      "creating-a-home-spa",
      "shower-area-configurations",
    ],
  },
} as const;
