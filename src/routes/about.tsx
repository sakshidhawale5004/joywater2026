...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Joy Water crafts timeless luxury bath fittings from a Pune atelier — engineered in solid brass and finished by hand." },
    ...
    <SiteLayout>
      <section className="relative h-[60vh] flex items-end bg-primary overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-8 pb-16 text-primary-foreground">
          ...
          <h1 className="font-serif text-5xl md:text-7xl max-w-3xl">A quarter-century of quiet craft.</h1>
        </div>
      </section>
      <section className="max-w-4xl mx-auto px-8 py-24 space-y-8 text-lg leading-relaxed text-foreground/80">
        <p>Joy Water began in a small Pune workshop with a single conviction: that the objects touching water in a home deserve the same reverence as the architecture around them.</p>
        <p>Twenty-five years later, that conviction still guides every piece we release. We machine our faucets from solid brass. We bond finishes with a PVD process that outlasts most bathrooms. And we still hand-carve every stone basin — because a machine cannot feel the grain of Italian marble the way a stonemason can.</p>
        <p>What we make is quiet. Restrained. Built for the long haul. It is not a statement. It is a foundation.</p>
      </section>
      <section className="bg-secondary py-24">
        <div className="max-w-6xl mx-auto px-8 grid md:grid-cols-3 gap-10">
          {[
            ["Solid Brass Core", "Every faucet body is CNC-machined from a single billet of lead-free brass."],
