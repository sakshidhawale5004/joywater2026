  ...
  return (
    <SiteLayout>
      <section className="relative bg-primary text-primary-foreground py-20 overflow-hidden">
        <img src="/JOY WATER BATHROOM ACCESSORIES (1)/32.jpg" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" />
        <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/80 to-transparent" />
        <div className="relative max-w-7xl mx-auto px-8 z-10">
          <p className="text-xs uppercase tracking-[0.3em] text-gold mb-4">Signature Series</p>
          <h1 className="font-serif text-5xl md:text-6xl">Chrome Finish</h1>
          <p className="mt-4 text-primary-foreground/70 max-w-2xl">
            {signatureSeriesProducts.length} premium bathroom accessories featuring high-end brass construction with elegant Chrome finish.
            Elevate your bathroom with our exclusive Signature Series collection.
          </p>
          <div className="mt-6 flex flex-wrap gap-4 text-sm">
            <div className="flex items-center gap-2">
              <span className="text-gold">✓</span>
              <span>High-End Brass Construction</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gold">✓</span>
