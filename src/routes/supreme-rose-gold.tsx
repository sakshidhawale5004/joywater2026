  ...
  return (
    <SiteLayout>
      <section className="relative bg-primary text-primary-foreground py-20 overflow-hidden">
        <img src="/JOY WATER BATHROOM ACCESSORIES (1)/113.jpg" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" />
        ...
        <div className="relative max-w-7xl mx-auto px-8 z-10">
          ...
          <p className="mt-4 text-primary-foreground/70 max-w-2xl">
            {roseGoldProducts.length} elegant bathroom accessories featuring premium brass construction with PVD Rose Gold finish.
            Create elegance with our Supreme Series rose gold collection.
          </p>
